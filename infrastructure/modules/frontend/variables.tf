...
variable "firebase_project_id" {
  type        = string
  description = "The Firebase Project ID (often same as project_id)."
}
...
variable "enable_trigger" {
  type        = bool
  description = "Whether to enable the Cloud Build trigger for deployment."
  default     = true
}
...
variable "service_name" {
  type        = string
  description = "The name of the service (used for trigger name)."
}
